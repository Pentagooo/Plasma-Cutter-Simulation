...
class ConstraintsConfig:
    ...
    # Agent durch "Schummeln" erreichen koennte.
    infeasible_penalty: float = -100.0

    # Maximale Episode-Laenge in Steps. Verhindert unendliche Episoden
    # (Trainings-Killer). Wert ist Heuristik -- pro Step macht der
    # Agent typischerweise einen Waypoint, also entspricht 200 Steps
    # einer recht komplexen Trajektorie.
...
class RewardConfig:
    ...
    w_coverage_delta: float = 500.0
    w_time_delta:     float = 0.5
    ...
    # Default 0 = keine zusaetzliche Strafe (der entgangene
    # Completion-Bonus reicht als Signal). Spaeter bei Bedarf hochziehen.
    w_failure_penalty: float = 0.0
